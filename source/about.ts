...
/**
 * `haeley.colors.branch()` provides the git revision branch at build-time.
 */
export const branch = (): undefined | string =>
    typeof __GIT_BRANCH__ !== 'undefined' ? `${__GIT_BRANCH__}` : undefined;

/**
 * `haeley.colors.commit()` provides the git revision commit at build-time.
 */
export const commit = (): undefined | string =>
    typeof __GIT_COMMIT__ !== 'undefined' ? `${__GIT_COMMIT__}` : undefined;

/**
 * `haeley.colors.version()` provides the npm package version at build-time.
 */
